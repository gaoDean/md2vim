...
My fork of [this fork](https://github.com/davysson/md2vim) of [the original repo](https://github.com/FooSoft/md2vim)

## Installation

For my fork, just clone this repo and run `go build` or just run the makefile:
```
$ make && make install
```
